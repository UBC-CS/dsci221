...
- Use different metrics — [time]{style="color: #e67e22;"}, [space]{style="color: #27ae60;"} most common
...
"Express WHAT as a function?" → Let them say "running time" or "work"

We'll write T(n) — running time as a function of input size n.
:::
...
Best case: 1
Worst case: n
Average case: (1+2+...+n)/n = (n+1)/2 ≈ n/2
...
At n = 1,000,000: 2n ≈ n. Constants are noise.
...
:::{.notes}
"We mostly use O, though we usually mean Θ."
:::
...
Double n → QUADRUPLE the work. QUADRATIC. $O(n^2)$
:::
