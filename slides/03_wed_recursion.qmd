...
96. Ninety-six moments of zen
95. Ninety-five grateful neurons
94. ...
...
13. Thirteen Piazza posts
12. Twelve merge commits
11. Eleven cups of ramen
10. Ten syntax errors
9. Nine ChatGPT tabs
8. Eight hours of sleep
7. Seven TA office hours
6. Six Pomodoros
5. **Five passing tests** 🎵
4. Four study rooms
3. Three stretch breaks
2. Two docs read
...
**Claim**: $f(n) = \frac{n(n+1)}{2}$ where $f(n) = 1 + 2 + \ldots + n$

We'll prove this by induction.

## Proof by Induction

Consider an arbitrary $n >= 0$.  Then consider the following cases:
