...
- `triangle_fast`: $T(n) = T(n/2) + O(1)$ — ONE call
- `triangle_double`: $T(n) = 2T(n/2) + O(1)$ — TWO calls

Different recurrences → **different running times**!
...
ax.text(6.0, 0.65, '← just return the other list!', fontsize=11, va='center', color='#27ae60', style='italic')
...
ax.text(0.85, 2.1, '↑ smallest in list 1', fontsize=9, ha='center', color='#e67e22')
...
ax.text(5.85, 2.1, '↑ smallest in list 2', fontsize=9, ha='center', color='#3498db')
...
ax.text(0.85, 2.9, '↑ min of left', fontsize=9, ha='center', color='#e67e22')
...
ax.text(5.85, 2.9, '↑ min of right', fontsize=9, ha='center', color='#3498db')
...
- Prepending the min keeps it sorted ✓

**Therefore, `merge` is correct for all inputs.** ∎
...
ax.text(2.2, 2.5, '🪄 recursion', ha='center', fontsize=10, style='italic', color='#8e44ad')
ax.text(7.7, 2.5, '🪄 recursion', ha='center', fontsize=10, style='italic', color='#8e44ad')
...
ax.text(2.2, 0.9, 'sorted ✓', ha='center', fontsize=9, color='#27ae60')
...
ax.text(7.7, 0.9, 'sorted ✓', ha='center', fontsize=9, color='#27ae60')
...
ax.text(5, -1.0, 'Sorted! ✓', ha='center', fontsize=12, color='#1e8449', fontweight='bold')
...
6. Therefore `merge_sort` works for size $n$ ✓

**By induction, `merge_sort` is correct for all $n$.** ∎
