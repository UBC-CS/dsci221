...
Today: a technique to **prove** correctness.

:::{.notes}
"Efficiency is about scaling. Correctness is about trust. Today: how do we PROVE an algorithm works?"
:::
...
After iteration $a = 5$, suppose we have:
